...
public class VideoAdapter extends RecyclerView.Adapter{
    ...
    //设置数据list
    public void setList(List<VideoBean> list){this.list=list;}
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder,final int i) {
        ...
        viewHolder1.tvtitle1.setText(videoBean.getName());
        viewHolder1.tvdescript1.setText(videoBean.getDescription());
        viewHolder1.tvtime1.setText(videoBean.getUpdate_time());
        //条目中的监听摁扭
        ...
        Picasso.with(context)
                .load("http://amicool.neusoft.edu.cn/Uploads/"+videoBean.getThumb())
