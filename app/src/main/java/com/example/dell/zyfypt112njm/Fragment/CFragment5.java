...
import com.example.dell.zyfypt112njm.Adapter.CTcaseAdapter;
...
import com.example.dell.zyfypt112njm.model.CTcaseModel;
...
public class CFragment5 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ctcaseModel.getResultList("tcase",page, LoginActivity.sessionID,listListener);
