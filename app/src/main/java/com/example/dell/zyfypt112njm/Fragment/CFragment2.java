...
import com.example.dell.zyfypt112njm.Adapter.CTwareAdapter;
...
import com.example.dell.zyfypt112njm.model.CTwareModel;
...
public class CFragment2 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ctwareModel.getResultList("tware",page, LoginActivity.sessionID,listListener);
