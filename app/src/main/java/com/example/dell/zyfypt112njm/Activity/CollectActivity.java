...
import com.example.dell.zyfypt112njm.Fragment.CFragment1;
import com.example.dell.zyfypt112njm.Fragment.CFragment2;
import com.example.dell.zyfypt112njm.Fragment.CFragment3;
import com.example.dell.zyfypt112njm.Fragment.CFragment4;
import com.example.dell.zyfypt112njm.Fragment.CFragment5;
...
public class CollectActivity extends AppCompatActivity {
    ...
    private CFragment1 fragment1;
    private CFragment2 fragment2;
    private CFragment3 fragment3;
    private CFragment4 fragment4;
    private CFragment5 fragment5;
    ...
    private class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) { //根据位置返回体某个导航上对应的Fragment
            switch (position) {
                case 0:
                    if (fragment1 == null) {
                        fragment1 = new CFragment1();
                    }
                    return fragment1;
                case 1:
                    if (fragment2 == null) {
                        fragment2 = new CFragment2();
                    }
                    return fragment2;
                case 2:
                    if (fragment3 == null) {
                        fragment3 = new CFragment3();
                    }
                    return fragment3;
                case 3:
                    if (fragment4 == null) {
                        fragment4 = new CFragment4();
                    }
                    return fragment4;
                case 4:
                    if (fragment5 == null) {
                        fragment5 = new CFragment5();
                    }
                    return fragment5;
                default:
                    return null;
