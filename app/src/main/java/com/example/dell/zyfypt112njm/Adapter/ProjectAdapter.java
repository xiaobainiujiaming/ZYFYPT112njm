...
public class ProjectAdapter extends RecyclerView.Adapter{
    ...
    //设置数据list
    public void setList(List<ProjectBean> list){this.list=list;}
    @NonNull
    @Override
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int i) {
        ...
        viewHolder1.tvtitle1.setText(projectBean.getName());
        viewHolder1.tvdescript1.setText(projectBean.getDescription());
        viewHolder1.tvtime1.setText(projectBean.getUpdate_time());
        //条目中的监听摁扭
        ...
        Picasso.with(context)
                .load("http://amicool.neusoft.edu.cn/Uploads/"+projectBean.getThumb())
