...
import com.example.dell.zyfypt112njm.Adapter.AArticleAdapter;
...
import com.example.dell.zyfypt112njm.model.AArticleModel;
...
public class AFragment1 extends Fragment{
    ...
    private AArticleAdapter adapter;//适配器
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        aArticleModel.getResultList("article", page,  LoginActivity.sessionID, userId,listListener);
...
//
    ...
    private void initRecyclerView() {
        ...
        //创建Adaper
        adapter =new AArticleAdapter(context);
